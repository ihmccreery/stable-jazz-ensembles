...
\begin{frame}
	...
	% TODO CITE 
	% https://home.oberlin.edu/home/2013/03/29/jazz-at-the-cat
...
\begin{frame}
	...
	% TODO CITE
	% http://oberlinreview.org/wp-content/uploads/2013/12/MenShortBeards_by-Yvette-Chen_MASTERWEB-1024x682.jpg
...
%	\frametitle{A lemma}
%
%	\emph{Lemma.} For every $a_i \in A'$, there exist $j_1, j_2 \in \{1, 2, 3\}, j_1 \neq j_2$ such that
%	\[
%	a_i[j_1]w_{a_i}x_{a_i} \in M
%	\text{ and }
%	a_i[j_2]y_{a_i}z_{a_i} \in M.
%	\]
%
%	\begin{proof}
%	Unless $x_{a_i}$ is matched, $a_i[1]w_{a_i}x_{a_i}$ is destabilizing.
%
%	Similarly, unless $z_{a_i}$ is matched, $a_i[1]y_{a_i}z_{a_i}$ or $a_i[2]y_{a_i}z_{a_i}$ is destabilizing.
%	\end{proof}
%\end{frame}
...
%	\begin{tabular}{r | c c c}
%		\vdots \\
%		$a_i[1]$ &	\underline{$w_{a_i}x_{a_i}$} &	$y_{a_i}z_{a_i}$ &	$b_{j_1}d_{l_1}$ \\
%		$a_i[2]$ &	$w_{a_i}x_{a_i}$ &	$y_{a_i}z_{a_i}$ &	$b_{j_2}d_{l_2}$ \\
%		$a_i[3]$ &	$w_{a_i}x_{a_i}$ &	$y_{a_i}z_{a_i}$ &	$b_{j_3}d_{l_3}$ \\
%		\vdots \\
%		\hline
%		\vdots \\
%		$w_{a_i}$ &	\underline{$a_i[1]x_{a_i}$} &	$a_i[2]x_{a_i}$ &	$a_i[3]x_{a_i}$ \\
%		$y_{a_i}$ &	$a_i[1]x_{a_i}$ &	$a_i[2]x_{a_i}$ &	$a_i[3]x_{a_i}$ \\
%		\vdots \\
%		\hline
%		\vdots \\
%		$x_{a_i}$ &	$a_i[3]w_{a_i}$ &	$a_i[2]w_{a_i}$ &	\underline{$a_i[1]w_{a_i}$} \\
%		$z_{a_i}$ &	$a_i[3]y_{a_i}$ &	$a_i[2]y_{a_i}$ &	$a_i[1]y_{a_i}$ \\
%		\vdots \\
%	\end{tabular}
%\end{frame}
